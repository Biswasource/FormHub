      ...
      <div className="flex flex-col items-center justify-center w-full px-4 sm:px-12 lg:px-20 py-12 lg:py-0">
        <Card className="w-full max-w-[420px] bg-transparent border-none shadow-none ring-0">
          <CardHeader className="flex items-center flex-col pb-2">
            ...
            <CardTitle className="text-[28px] font-bold tracking-tight text-white m-0">Welcome back!</CardTitle>
            <br/>
            <CardDescription className="text-[15.5px] text-[#A1A1AA] m-0">
              Login to your FORMHUBSaccount
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-5 mt-4">
            ...
            {step === 1 ? (
              <form onSubmit={handleSendOtp} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-[13px] text-[#A1A1AA] font-normal">
                    Email
                  </Label>
                  <Input
                    id="email"
                ...
                <Button disabled={isLoading} type="submit" className="w-full bg-white text-black hover:bg-gray-200 h-10 rounded-md font-semibold text-[15px] mt-1">
            ...
            <div className="space-y-3">
              <Button type="button" variant="outline" className="w-full bg-[#0a0a0a] border-[#27272a] text-[#d4d4d8] hover:bg-[#18181b] hover:text-white h-10 rounded-md font-medium text-[14px] flex items-center justify-center gap-2">
          ...
          <CardFooter className="flex justify-center mt-2 pb-0 pt-4 bg-transparent border-none">
